        ...
        <form>
          ...
          <div className="flex items-center border border-gray-300/70 h-10 rounded-sm mb-3">
            ...
            <div className="h-full flex items-center justify-center pr-2 ">
              <Eye className="shrink-0 w-5 text-gray-500 cursor-pointer" />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="bg-gray-800 cursor-pointer text-white w-full mt-3 px-4 py-2 rounded-sm flex items-center gap-1 justify-center text-sm hover:bg-gray-900"
          >
            Login <LogIn className="w-5" />
          </button>
          {/* <div className="error w-full mt-3 px-4 py-2 rounded-sm bg-red-200/70 text-red-900 border border-red-300/50">
            <p className="w-full text-center text-sm">
              There is an error Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Iste, reiciendis.
            </p>
          </div>
          <div className="error w-full mt-3 px-4 py-2 rounded-sm bg-green-500/20 text-green-900 border border-green-300/70">
            <p className="w-full text-center text-sm">
              There is an error Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Iste, reiciendis.
            </p>
